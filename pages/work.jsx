...
import tesseractSpinning from '../assets/screenshots/tesseract/Spinning.gif'
import tesseractLookingAtStakeholder from '../assets/screenshots/tesseract/LookingAtStakeholder.gif'
    ...
    return (
      <div>
        ...
        <ContentFrame title={"Work"}>
          <ProjectContainer>
            <Project name={"Tesseract"} images={[tesseractSpinning,tesseractLookingAtStakeholder]} description={`Tesseract is a prototype stakeholder management tool. The design for tesseract was inspired by fictional UI's seen in movies like "The Martian" and "James Bond". We were trying to make the user feel like a badass and the tool look high tech`}/>
